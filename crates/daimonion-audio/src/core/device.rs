...
impl From<daimonion_db::DeviceType> for DeviceType {
    fn from(device_type: daimonion_db::DeviceType) -> Self {
        match device_type {
            daimonion_db::DeviceType::Input => DeviceType::Input,
            daimonion_db::DeviceType::Output => DeviceType::Output,
        }
    }
}

impl From<DeviceType> for daimonion_db::DeviceType {
    fn from(device_type: DeviceType) -> Self {
        match device_type {
            DeviceType::Input => daimonion_db::DeviceType::Input,
            DeviceType::Output => daimonion_db::DeviceType::Output,
        }
    }
}

impl From<DeviceType> for Arc<daimonion_db::DeviceType> {
    fn from(device_type: DeviceType) -> Self {
...
impl From<daimonion_db::AudioDevice> for AudioDevice {
    fn from(device: daimonion_db::AudioDevice) -> Self {
        AudioDevice {
            name: device.name,
