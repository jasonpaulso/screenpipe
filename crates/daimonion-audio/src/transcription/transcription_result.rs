...
use daimonion_db::{DatabaseManager, NewDiarizationSegment, Speaker};
            ...
            .insert_audio_chunk_and_transcription(
                ...
                &daimonion_db::AudioDevice {
                    ...
                    device_type: match result.input.device.device_type {
                        crate::core::device::DeviceType::Input => daimonion_db::DeviceType::Input,
                        crate::core::device::DeviceType::Output => {
                            daimonion_db::DeviceType::Output
                        }
                    },
                },
                speaker_id,
