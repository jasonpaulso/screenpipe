...
#[allow(dead_code)]
pub async fn new_test_vad() -> daimonion_audio::vad::silero::SileroVad {
    daimonion_audio::vad::silero::SileroVad::ensure_model_available()
        .await
        .expect("silero model prefetch failed");
    daimonion_audio::vad::silero::SileroVad::new()
        .await
