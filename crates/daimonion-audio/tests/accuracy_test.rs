...
use daimonion_audio::core::device::default_input_device;
...
use daimonion_audio::transcription::stt::SAMPLE_RATE;
use daimonion_audio::vad::{silero::SileroVad, VadEngine};
use daimonion_audio::{resample, AudioInput, TranscriptionEngine};
...
async fn test_transcription_accuracy() {
    ...
    for (audio_file, expected_transcription) in test_cases {
        ...
        let task = tokio::spawn(async move {
            ...
            let audio_data =
                daimonion_audio::pcm_decode(&audio_path).expect("Failed to decode audio file");
