...
async fn whisper_hallucination_before_after() {
    ...
    use daimonion_audio::transcription::whisper::model::create_whisper_context_parameters;
    use daimonion_audio::transcription::whisper::model::get_cached_whisper_model_path;
    ...
    let crackle_transcript = daimonion_audio::transcription::whisper::batch::process_with_whisper(
        &crackle_audio,
    ...
    let silence_transcript = daimonion_audio::transcription::whisper::batch::process_with_whisper(
        &silence_audio,
        vec![Language::English],
        &mut state,
        &[],
