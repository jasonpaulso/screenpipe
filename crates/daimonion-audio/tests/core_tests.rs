...
mod tests {
    ...
    use daimonion_audio::core::record_and_transcribe;
    use daimonion_audio::core::stream::AudioStream;
    use daimonion_audio::speaker::embedding::EmbeddingExtractor;
    use daimonion_audio::speaker::embedding_manager::EmbeddingManager;
    use daimonion_audio::speaker::prepare_segments;
    use daimonion_audio::vad::{silero::SileroVad, VadEngine};
    use daimonion_audio::{pcm_decode, AudioInput, TranscriptionEngine};
    ...
    async fn test_record_and_transcribe() {
        ...
        let result = record_and_transcribe(
            ...
            Arc::new(sender),
            is_running,
            Arc::new(daimonion_audio::metrics::AudioPipelineMetrics::new()),
        )
        .await;
    ...
    async fn test_audio_transcription_language() {
        ...
        let audio_data = daimonion_audio::pcm_decode("test_data/Arifi.wav")
