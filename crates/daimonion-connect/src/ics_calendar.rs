...
fn store_encryption_key() -> Result<[u8; 32], String> {
    match daimonion_secrets::keychain::get_key() {
        ...
        daimonion_secrets::keychain::KeyResult::AccessDenied => Err(
        ...
        daimonion_secrets::keychain::KeyResult::NotFound => Err(
        ...
        daimonion_secrets::keychain::KeyResult::Unavailable => Err(
