...
//! `daimonion_core::video` now so downstream consumers (the commercial
...
//! `daimonion_engine::video::*` import path thanks to this re-export.

pub use daimonion_core::video::*;
