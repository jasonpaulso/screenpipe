...
fn monitor_for_point(
    monitors: &[daimonion_screen::monitor::SafeMonitor],
    x: f64,
    y: f64,
...
impl Inner {
    ...
    fn resolve_and_emit(&self, monitors: &[daimonion_screen::monitor::SafeMonitor]) {
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        let activate_cb = move |_note: &ns::Notification| {
            ...
            cidre::objc::ar_pool(|| {
                ...
                // by it.
                let monitors =
                    futures::executor::block_on(daimonion_screen::monitor::list_monitors());
