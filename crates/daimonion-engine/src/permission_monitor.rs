...
use daimonion_core::permissions::{check_permissions, PermissionStatus};
...
fn keychain_accessible() -> bool {
    use daimonion_secrets::keychain::{get_key, is_keychain_available, KeyResult};
    ...
    if !daimonion_secrets::is_encryption_requested(
