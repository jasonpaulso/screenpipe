...
use daimonion_audio::audio_manager::builder::TranscriptionMode;
use daimonion_audio::audio_manager::AudioManagerBuilder;
use daimonion_audio::core::engine::AudioTranscriptionEngine;
use daimonion_audio::meeting_streaming::MeetingStreamingConfig;
use daimonion_audio::transcription::deepgram::DeepgramTranscriptionConfig;
use daimonion_audio::transcription::VocabularyEntry;
use daimonion_audio::vad::VadEngineEnum;
use daimonion_config::{ChannelConfig, DbConfig};
use daimonion_core::Language;
use daimonion_screen::PipelineMetrics;
...
impl RecordingConfig {
    ...
    pub fn from_settings(
        ...
        daimonion_config::set_record_while_locked(settings.record_while_locked);
...
mod tests {
    ...
    fn settings_with(lan: bool, api_auth: bool) -> daimonion_config::RecordingSettings {
    ...
    fn build(s: &daimonion_config::RecordingSettings) -> RecordingConfig {
        RecordingConfig::from_settings(s, std::path::PathBuf::from("/tmp/sp_test"), None)
    }

    #[test]
    fn defaults_to_loopback() {
        let c = build(&daimonion_config::RecordingSettings::default());
    ...
    fn privacy_capture_toggles_flow_to_ui_recorder_config() {
        let settings = daimonion_config::RecordingSettings {
        ...
        assert_eq!(
            ...
            daimonion_a11y::ExtractionThreadPriority::Lowest
        );
