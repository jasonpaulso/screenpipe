...
pub async fn sync_init(
    ...
    let machine_id = request
        .machine_id
        .unwrap_or_else(daimonion_core::sync::get_or_create_machine_id);
    ...
    tokio::spawn(async move {
        use daimonion_core::sync::SyncEvent;
...
pub async fn sync_connections_push(
    ...
    use daimonion_core::connections::sync::*;
...
async fn download_connection_manifest(
    manager: &Arc<daimonion_core::sync::SyncManager>,
) -> daimonion_core::connections::sync::ConnectionSyncManifest {
    use daimonion_core::connections::sync::ConnectionSyncManifest;
    use daimonion_core::sync::BlobType;
...
async fn upload_connection_manifest(
    manager: &Arc<daimonion_core::sync::SyncManager>,
    manifest: &daimonion_core::connections::sync::ConnectionSyncManifest,
) -> Vec<String> {
    use daimonion_core::sync::BlobType;
...
async fn build_connections_local_manifest(
    ...
    machine_id: &str,
    secret_store: Option<&daimonion_secrets::SecretStore>,
) -> daimonion_core::connections::sync::ConnectionSyncManifest {
    daimonion_core::connections::sync::build_local_manifest(
        screenpipe_dir,
        machine_id,
        secret_store,
    )
...
async fn apply_connections_manifest_to_disk(
    manifest: &daimonion_core::connections::sync::ConnectionSyncManifest,
    actions: &[daimonion_core::connections::sync::ConnectionSyncAction],
    screenpipe_dir: &std::path::Path,
    secret_store: Option<&daimonion_secrets::SecretStore>,
) -> Vec<String> {
    daimonion_core::connections::sync::apply_manifest_to_disk(
        manifest,
        actions,
        screenpipe_dir,
        secret_store,
...
fn has_deleted_connection_action(
    ...
    actions.iter().any(|action| {
        matches!(
            action,
            daimonion_core::connections::sync::ConnectionSyncAction::Deleted(_)
        )
    })
}

fn connection_action_str(
    action: &daimonion_core::connections::sync::ConnectionSyncAction,
) -> String {
    use daimonion_core::connections::sync::ConnectionSyncAction;
    match action {
...
async fn download_pipe_manifest(
    manager: &Arc<daimonion_core::sync::SyncManager>,
) -> daimonion_core::pipes::sync::PipeSyncManifest {
    use daimonion_core::pipes::sync::PipeSyncManifest;
    use daimonion_core::sync::BlobType;
...
async fn upload_pipe_manifest(
    manager: &Arc<daimonion_core::sync::SyncManager>,
    manifest: &daimonion_core::pipes::sync::PipeSyncManifest,
) -> Vec<String> {
    use daimonion_core::sync::BlobType;
...
async fn build_memories_local_manifest(
    ...
    screenpipe_dir: &std::path::Path,
    machine_id: &str,
) -> daimonion_core::memories::sync::MemoriesSyncManifest {
    use daimonion_core::memories::sync::{MemoriesSyncManifest, SyncedMemory};
...
async fn apply_memories_manifest_to_db(
    db: &Arc<DatabaseManager>,
    manifest: &daimonion_core::memories::sync::MemoriesSyncManifest,
    actions: &[daimonion_core::memories::sync::MemorySyncAction],
) -> Vec<String> {
    use daimonion_core::memories::sync::MemorySyncAction;
...
async fn download_memories_manifest(
    ...
    use daimonion_core::memories::sync::MemoriesSyncManifest;
    use daimonion_core::sync::BlobType;
...
pub async fn sync_memories_push(
    ...
    use daimonion_core::memories::sync::*;
...
fn action_str(a: &daimonion_core::memories::sync::MemorySyncAction) -> String {
    use daimonion_core::memories::sync::MemorySyncAction;
    match a {
