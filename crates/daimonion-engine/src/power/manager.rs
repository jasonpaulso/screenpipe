...
use daimonion_events::{send_event, PowerProfileChangedEvent, POWER_PROFILE_CHANGED_EVENT};
...
pub fn start_power_manager_with_pref(initial_pref: PowerMode) -> Arc<PowerManagerHandle> {
    ...
    tokio::spawn(async move {
        ...
        daimonion_audio::vad::set_min_speech_ratio(profile.vad_min_speech_ratio);
        ...
        loop {
            ...
            daimonion_audio::vad::set_min_speech_ratio(new_profile.vad_min_speech_ratio);
