...
//! [`daimonion_connect::connections::browser`]; this file is a thin shell
...
use daimonion_connect::connections::browser::{
...
pub use daimonion_connect::connections::browser::BrowserBridge;
