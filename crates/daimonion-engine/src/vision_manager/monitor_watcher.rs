...
use daimonion_events::PermissionKind;
use daimonion_screen::monitor::{list_monitors_detailed, MonitorListError};
...
pub async fn start_monitor_watcher(
    ...
    audio_manager: Option<daimonion_audio::audio_manager::AudioManager>,
) -> anyhow::Result<()> {
