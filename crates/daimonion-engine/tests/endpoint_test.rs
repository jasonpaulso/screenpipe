...
mod tests {
    ...
    use daimonion_db::{ContentType, DatabaseManager, SearchResult};
    use daimonion_engine::routes::search::SearchResponse;
    use daimonion_engine::SCServer;
    use daimonion_engine::{ContentItem, PaginatedResponse};
    use daimonion_screen::OcrEngine; // Adjust this import based on your actual module structure
    ...
    async fn test_search_audio_with_length_constraints() {
        ...
        let _ = db
            .insert_audio_transcription(
                ...
                0,
                "",
                &daimonion_db::AudioDevice {
                    name: "test1".to_string(),
                    device_type: daimonion_db::DeviceType::Input,
                },
                None,
                None,
                None,
    ...
    async fn test_recent_tasks_no_bleeding_production_db() {
        ...
        let db_path = format!("{}/.daimonion/db.sqlite", home);
