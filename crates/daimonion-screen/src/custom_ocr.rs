...
impl From<daimonion_db::CustomOcrConfig> for CustomOcrConfig {
    fn from(config: daimonion_db::CustomOcrConfig) -> Self {
        CustomOcrConfig {
...
impl From<CustomOcrConfig> for daimonion_db::CustomOcrConfig {
    fn from(config: CustomOcrConfig) -> Self {
        daimonion_db::CustomOcrConfig {
            api_url: config.api_url,
            api_key: config.api_key,
            timeout_ms: config.timeout_ms,
        }
