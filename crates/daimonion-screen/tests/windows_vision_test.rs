...
mod tests {
    use chrono::Utc;
    use daimonion_screen::capture_screenshot_by_window::{CapturedWindow, WindowFilters};
    ...
    use daimonion_screen::core::{continuous_capture, process_ocr_task, RawCaptureResult};
    use daimonion_screen::monitor::get_default_monitor;
    use daimonion_screen::ocr_cache::WindowOcrCache;
    use daimonion_screen::{OcrEngine, PipelineMetrics};
    use std::sync::Arc;
