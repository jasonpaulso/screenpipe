...
//!
//! ```rust,ignore
//! use daimonion_core::sync::{NewUserKeyData, SyncKeys};
//!
...
//!
//! ```rust,ignore
//! use daimonion_core::sync::{ExistingUserKeyData, SyncKeys};
//!
...
//!
//! ```rust,ignore
//! use daimonion_core::sync::{encrypt_blob, BlobType};
//!
//! // Encrypt OCR text
...
//!
//! ```rust,ignore
//! use daimonion_core::sync::decrypt_blob;
//!
