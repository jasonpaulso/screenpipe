...
use daimonion_sync::destination::HttpPutDirect;
use daimonion_sync::{BlobDestination, PutRequest, SyncError as TransportError};
...
/// Map a `daimonion_sync::SyncError` to this crate's `SyncError`,
