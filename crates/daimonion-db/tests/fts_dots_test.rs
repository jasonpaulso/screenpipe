...
mod tests {
    use chrono::Utc;
    use daimonion_db::{ContentType, DatabaseManager, OcrEngine};
    use std::sync::Arc;
    ...
    fn test_sanitize_fts5_query_dots() {
        use daimonion_db::text_normalizer::sanitize_fts5_query;
    ...
    fn test_value_to_fts5_column_query() {
        use daimonion_db::text_normalizer::value_to_fts5_column_query;
