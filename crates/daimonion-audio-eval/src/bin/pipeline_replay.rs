...
use daimonion_audio::{pcm_decode, resample};
use daimonion_audio_eval::{load_rttm, score_pipeline, RttmSegment};
use daimonion_core::Language;
use daimonion_db::{DatabaseManager, NewDiarizationSegment, ReplacementAudioTranscription};
use serde::Serialize;
...
fn rows_to_hypothesis(rows: &[daimonion_db::AudioResult]) -> Vec<RttmSegment> {
