...
# transcripts) into crates/daimonion-audio-eval/evals/fixtures/librispeech/.
...
#
# Once unpacked, run:
#   cargo run --release -p daimonion-audio-eval --bin daimonion-eval-transcription -- \
#     --librispeech-dir crates/daimonion-audio-eval/evals/fixtures/librispeech/LibriSpeech/test-clean
...
echo "  cargo run --release -p daimonion-audio-eval --bin daimonion-eval-transcription -- \\"
