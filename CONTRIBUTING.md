...
sqlite3 ~/.daimonion/db.sqlite "DELETE FROM _sqlx_migrations WHERE version = XXXXXXXXXX;"

# verify migrations
sqlite3 ~/.daimonion/db.sqlite "SELECT * FROM _sqlx_migrations;"

# if issues persist, you can take the nuclear approach:
# 1. backup your database
cp ~/.daimonion/db.sqlite ~/.daimonion/db.sqlite.backup

# 2. reset migrations table
sqlite3 ~/.daimonion/db.sqlite "DROP TABLE _sqlx_migrations;"
```
