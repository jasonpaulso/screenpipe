  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        <ShortcutRow type="global" shortcut="showScreenpipeShortcut" title="toggle daimonion overlay" description="show/hide the main interface" value={settings.showScreenpipeShortcut} />
