    ...
    return (
      <div className="space-y-6">
        <p className="text-muted-foreground text-sm mb-4">
          Monitor storage usage for your Daimonion data
        </p>
        <Card>
          ...
          {isLoading ? (
            ...
            <div className="space-y-1.5 ml-[26px]">
              ...
              {diskUsage?.other?.logs_size?.includes("GB") && (
                <p className="text-[11px] text-destructive mt-1">⚠️ Logs are large. Delete old ones at ~/.daimonion/*.log</p>
              )}
              <div className="flex items-center justify-between text-xs">
