 ...
 *   NEXT_PUBLIC_DAIMONION_WEB_URL=https://my-preview.vercel.app \
 *   NEXT_PUBLIC_DAIMONION_FORCE_BILLING_GATE=true \
 *   bun tauri dev
 *
 *   # test against a local website (needs the website's own .env populated):
 *   NEXT_PUBLIC_DAIMONION_WEB_URL=http://localhost:3000 ... bun tauri dev
 *
...
/** Build a website URL, honoring NEXT_PUBLIC_DAIMONION_WEB_URL when set. */
