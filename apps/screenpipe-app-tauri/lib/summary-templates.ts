...
export const FALLBACK_TEMPLATES: TemplatePipe[] = [
  {
    ...
    icon: "\u26A1",
    featured: true,
    prompt: `<role>You are a daimonion automation expert. Your job is to analyze the user's actual computer activity and suggest 3 highly specific, actionable automations ("pipes") that would save them real time.</role>
...
Run these queries against the daimonion API to understand the user's work patterns. Use the last 24 hours of data.
